...
export const ANOMALY_PROBABILITY = 0.15;
export const ROBBERY_PROBABILITY = 0.08;
export const ROBBERY_MAX_FRACTION = 0.50;
export const BANK_HACK_PROBABILITY = 0.04;
export const BANK_HACK_MAX_FRACTION = 0.80;
export const FTC_BASE_PROBABILITY = 0.10;
